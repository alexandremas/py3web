...
class TestRouter(unittest.TestCase):
    ...
    def testBasic(self):
        ...
        self.assertRaises(py3web.HTTPError, self.match, '//no/m/at/ch/')
    ...
    def testValueErrorInFilter(self):
        ...
        self.assertRaises(py3web.HTTPError, self.match, '/int/noint')


    def testIntFilter(self):
        self.assertMatches('/object/<id:int>', '/object/567', id=567)
        self.assertRaises(py3web.HTTPError, self.match, '/object/abc')
    ...
    def testFloatFilter(self):
        ...
        self.assertMatches('/object/<id:float>', '/object/1.', id=1)
        self.assertRaises(py3web.HTTPError, self.match, '/object/abc')
        self.assertRaises(py3web.HTTPError, self.match, '/object/')
        self.assertRaises(py3web.HTTPError, self.match, '/object/.')
    ...
    def testParentheses(self):
        ...
        self.assertRaises(py3web.HTTPError, self.match, '/func2(baz)')
    ...
    def testBuild(self):
        ...
        self.assertRaises(py3web.RouteBuildError, build, 'test')
    ...
    def testBuildAnon(self):
        ...
        self.assertRaises(py3web.RouteBuildError, build, 'anonroute')
    ...
    def test_lots_of_routes(self):
        n = py3web.Router._MAX_GROUPS_PER_PATTERN+10
        for i in range(n):        
